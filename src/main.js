...
function dashboardView(){
  ...
  <section class="card profile profile-dual"><div><div class="eyebrow">USER NAME</div><h2>${esc(p?.name||user?.email||"User")}</h2></div><div class="offer-member"><div class="eyebrow">OFFER MEMBER</div><h2>${esc(member.name||"Member")}</h2></div></section>
